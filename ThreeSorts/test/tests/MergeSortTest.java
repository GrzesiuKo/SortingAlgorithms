...
public class MergeSortTest {
    ...
    @Test
    public void testSortIfPairsAreSorted() {
        //Given
        double[] given = {-50, -10, -100, -40, -20, -90, -60, -70, -30, -80};
        double[] expected = {-100, -90, -80, -70, -60, -50, -40, -30, -20, -10};
        //When
        given = mergeSort.sort(given);
        //Then
        assertArrayEquals(expected, given, 0);
